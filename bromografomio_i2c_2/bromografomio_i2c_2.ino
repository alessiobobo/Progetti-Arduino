...
#define ONE_WIRE_BUS 13
  ...
  uint8_t lampOn[8]={0xe,0xe,0xa,0xa,0xa,0xa,0xe,0xe};
  uint8_t lampOff[8]={0xe,0x0,0x0,0x0,0x0,0x0,0x0,0xe};
  uint8_t checkboxNo[8]={0x0,0xe,0x11,0x11,0x11,0xe,0x0,0x0};
  uint8_t checkboxSi[8]={0x0,0xe,0x1f,0x1f,0x1f,0xe,0x0,0x0};
  uint8_t orologio[8]={0x0,0x0,0xe,0x15,0x17,0x11,0xe,0x0};
  byte termo[8]={0xc,0xe,0xc,0xe,0xc,0x1e,0x1e,0xc};
  uint8_t acceso[8]={0xa,0x15,0x0,0xa,0x15,0x0,0xa,0x15};
  uint8_t guasto[8]={0xe,0xe,0xc,0x8,0x2,0x6,0xe,0xe};
  ...
  switch (indiceMenu){
         ...
         switch (indiceSottomenu){
            case 0:
              ...
              if(!digitalRead(pulsanteDx2)||!digitalRead(pulsanteSx2)){
                ...
                while(!digitalRead(pulsanteSx2)||!digitalRead(pulsanteDx2));
                lcd.clear();
              }
          break;
          default:
    ...
    case 3:
     ...
     case 4:
       ...
       lcd.setCursor(19-((String)(100-rimanente*100/timer1)).length(),1);
