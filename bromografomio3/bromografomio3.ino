...
void accendiLamp(){
  digitalWrite(rele1, statoLamp[0]);
  digitalWrite(rele1, statoLamp[1]);
  digitalWrite(rele1, statoLamp[2]);
  digitalWrite(rele1, statoLamp[2]);
}
  ...
  switch (indiceMenu){
    ...
    case 1:                                        //lampade
            ...
            case 1:
              ...
              if(guastoLamp[0]){
                ...
                if(digitalRead(pulsanteDx)){
                  ...
                  delay(attesaCheck);
                  if(analogRead(fotoresistenza1>soglia)){
            ...
            case 2:
              ...
              if(guastoLamp[1]){
                ...
                if(digitalRead(pulsanteDx)){
                  ...
                  delay(attesaCheck);
                  if(analogRead(fotoresistenza2>soglia)){
            ...
            case 3:
              ...
              if(guastoLamp[2]){
                ...
                if(digitalRead(pulsanteDx)){
                  ...
                  delay(attesaCheck);
                  if(analogRead(fotoresistenza3>soglia)){
            ...
            case 4:
              ...
              if(guastoLamp[3]){
                ...
                if(digitalRead(pulsanteDx)){
                  ...
                  delay(attesaCheck);
                  if(analogRead(fotoresistenza4>soglia)){
        ...
        case 4:
          ...
          lcd.print("\6    Pausa");
          digitalWrite(rele1, statoLamp[0]);
          digitalWrite(rele2, statoLamp[1]);
          digitalWrite(rele3, statoLamp[2]);
          digitalWrite(rele4, statoLamp[3]);
          rimanente=timer1+inizio/1000-timer0_overflow_count/1000;
          lcd.setCursor(0,0);
          if(rimanente/3600<10){
            lcd.print(0);
          }
          lcd.print(rimanente/3600);
          lcd.print(":");
          if((rimanente%3600)/60<10){
            lcd.print(0);
          }
          lcd.print((rimanente%3600)/60);
          lcd.print(":");
          if((rimanente%3600)%60<10){
            lcd.print(0);
          }
          ...
          if(statoLamp[0] && analogRead(fotoresistenza1)<soglia){
          guastoLamp[0]=1;
          statoLamp[0]=0;
          indiceMenu=7;
          lcd.clear();
          }
          if(statoLamp[1] && analogRead(fotoresistenza1)<soglia){
          guastoLamp[1]=1;
          statoLamp[1]=0;
          indiceMenu=7;
          lcd.clear();
          }
          if(statoLamp[2] && analogRead(fotoresistenza1)<soglia){
          guastoLamp[2]=1;
          statoLamp[2]=0;
          indiceMenu=7;
          lcd.clear();
          }
          if(statoLamp[3] && analogRead(fotoresistenza1)<soglia){
          guastoLamp[3]=1;
          statoLamp[3]=0;
          indiceMenu=7;
          lcd.clear();
